                    ...
                    <p>Here I tested the mechanism offered by <a href="http://mozillalabs.com/">Mozilla Labs</a>.</p>
                    <p><a href="#"><img src="/images/mozl_sign_in_green.png" alt="Sign in!" title="Sign in!" onclick="doLogin();"/></a></p>
                    <p>&nbsp;</p>
